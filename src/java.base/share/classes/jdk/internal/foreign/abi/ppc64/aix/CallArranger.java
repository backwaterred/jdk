...
/**
 * For the Aix PPC64 C ABI specifically, this class uses namely CallingSequenceBuilder
 * to translate a C FunctionDescriptor into a CallingSequence, which can then be turned into a MethodHandle.
 */
public class CallArranger {
    public static final int MAX_INTEGER_ARGUMENT_REGISTERS = 8;
    public static final int MAX_VECTOR_ARGUMENT_REGISTERS = 12;
    private static final ABIDescriptor CAix = abiFor(
        // TODO
        /*
         * abiFor(
         *     VMStorage[] inputIntRegs,
         ...
         */
         ...
         new VMStorage[] { v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13 },
         new VMStorage[] { /* TODO */},
         new VMStorage[] { v2 },
    );
    ...
    public static Bindings getBindings(MethodType mt, FunctionDescriptor cDesc, boolean forUpcall) {
        CallingSequenceBuilder csb = new CallingSequenceBuilder(CAix, forUpcall);
        ...
        if (returnInMemory) {
            ...
            MemoryLayout layout = Aix.C_POINTER;
        ...
        if (!forUpcall) {
            ...
            csb.addArgumentBindings(long.class, Aix.C_LONG,
    ...
    public static MethodHandle arrangeDowncall(MethodType mt, FunctionDescriptor cDesc) {
        ...
        MethodHandle handle = new DowncallLinker(CAix, bindings.callingSequence).getBoundMethodHandle();
    ...
    public static MemorySegment arrangeUpcall(MethodHandle target, MethodType mt, FunctionDescriptor cDesc, MemorySession session) {
        ...
        return UpcallLinker.make(CAix, target, bindings.callingSequence, session);
    }
    ...
    static class StorageCalculator {
        ...
        VMStorage nextStorage(int type) {
            ...
            if (registerCount < maxRegisterArguments(type)) {
                VMStorage[] source =
                    (forArguments ? CAix.inputStorage : CAix.outputStorage)[type];
