...
public abstract class AixWatchKey extends AbstractWatchKey
{
    ...
    public static class TopLevelKey extends AixWatchKey
    {
        ...
        protected void rmSubKey(AixWatchKey.SubKey key)
        {
            subKeys.remove(key);
        }
    ...
    public int watchDescriptor() { return watchDescriptor; }

    @Override
    public boolean isValid()
    {
        return this.watchDescriptor != INVALID_WATCH_DESCRIPTOR;
    }
    ...
    {
        if (isValid()) {
            this.watchDescriptor = INVALID_WATCH_DESCRIPTOR;
